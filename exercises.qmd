...
for layer in range(12):
    ...
    contributions.append((f"L{layer}_MLP", (mlp @ paris_dir).item()))

    # Attention heads
    head_out = cache["result", layer][0, -1]  # [n_heads, d_model]
    for head in range(12):
        contrib = (head_out[head] @ paris_dir).item()
        contributions.append((f"L{layer}H{head}", contrib))
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ttsugriy/mechinterp-first-principles/blob/main/notebooks/exercises.ipynb)
