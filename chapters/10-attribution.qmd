...
::: {.callout-warning}
## Prerequisites
**Required**: [Chapter 3: Residual Stream](03-residual-stream.qmd) — understanding additive contributions
**Recommended**: [Chapter 8: Circuits](08-circuits.qmd) — understanding what we're trying to find
:::
...
3. **Ablation**: What happens if we remove it? (Chapter 12)
...
### Practical Example: "The capital of France is ___"
...
- MLP 8: patching recovers 78% → causally necessary
- Head 7.4: patching recovers 65% → causally important
- Head 5.2: patching recovers 8% → correlated but redundant

### When Attribution ≠ Patching
