...
::: {.callout-warning}
## Prerequisites
**Required**: [Chapter 5: Features](05-features.qmd) — understanding what features are and why neurons are polysemantic
:::
...
Chapter 5: What are we looking for? (Features—directions in that space.)
Chapter 6: What's the obstacle? (**Superposition—features are packed densely, hiding in polysemantic neurons.**)
