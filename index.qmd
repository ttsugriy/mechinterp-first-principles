...
Want to *do* something before reading theory? Try this:
...
2. **See attention patterns** (5 min): Visit [BertViz](https://github.com/jessevig/bertviz) or the [Transformer Explainer](https://poloclub.github.io/transformer-explainer/) to visualize how attention moves information between tokens.

You've now seen the two core phenomena this series explains: **features** (what networks represent) and **attention** (how they move information). The rest is understanding *why* it works this way.
:::

::: {.callout-note}
## Estimated Reading Times

| Arc | Articles | Total Reading Time |
|-----|----------|-------------------|
...
| **Total** | 15 articles + 3 summaries | **~5 hours** |

Each article is 12-22 minutes. Take breaks between arcs—the summaries are designed as natural stopping points.
:::
...
This series is designed to be accessible, but some background helps:
