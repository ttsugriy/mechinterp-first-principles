...
You've now seen the two core phenomena this book explains: **features** (what networks represent) and **attention** (how they move information). The rest is understanding *why* it works this way.
:::
...
Start with [Chapter 1: Why Reverse Engineer Neural Networks?](articles/01-why-reverse-engineer.qmd) to understand the motivation and scope of the project.
