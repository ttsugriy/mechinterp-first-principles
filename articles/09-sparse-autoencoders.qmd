...
This is an active area of research with no clean solution.
...
- **Matryoshka SAEs**: Train across multiple sparsity levels simultaneously
- **Contrastive losses**: Encourage features to be more distinct from each other
- **Dictionary initialization**: Better starting points for learning
