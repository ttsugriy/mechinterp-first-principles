...
::: {.callout-warning}
## Prerequisites
**Required**: [Article 6: Superposition](06-superposition.qmd) — understanding why features are compressed into overlapping representations
:::
...
- Features are directions in activation space (Article 5)
- Superposition compresses many features into few dimensions (Article 6)
- This creates polysemantic neurons that are hard to interpret
- Circuits are how features compose into algorithms (Article 8)
...
*Hint*: Think about what the input activation actually represents (from Article 6).
:::
...
Remember the pentagon from [Article 7](07-toy-models.qmd)? In that toy model, 5 sparse features arranged themselves as a regular pentagon in 2D—the optimal geometry for minimizing interference.
