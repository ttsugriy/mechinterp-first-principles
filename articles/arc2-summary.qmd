...
flowchart LR
    subgraph ARC2["Arc II: The Theory"]
        A5["Article 5<br/>Features"] --> A6["Article 6<br/>Superposition"]
        A6 --> A7["Article 7<br/>Toy Models"]
        A7 --> A8["Article 8<br/>Circuits"]
    end
```

## Key Concepts to Remember

### From Article 5: Features
...
- **Article 9 (SAEs)**: The tool for extracting features from superposition
- **Article 10 (Attribution)**: Which components contributed to the output?
- **Article 11 (Patching)**: Does this component *cause* the behavior?
- **Article 12 (Ablation)**: What happens if we remove it?
