...
From prior articles, recall:

- The residual stream is a *sum* of contributions from all components (Article 3)
- We can decompose this sum to see what each component contributed
- SAEs extract interpretable features from superposed representations (Article 9)
