...
- Features are directions; circuits are how they compose (Articles 5, 8)
- SAEs extract interpretable features from superposition (Article 9)
- Attribution finds candidates; patching tests causation; ablation tests necessity (Articles 10-12)
